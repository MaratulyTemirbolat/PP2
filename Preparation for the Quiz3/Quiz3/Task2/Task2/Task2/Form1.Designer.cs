namespace Task2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.Down);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.Left);
			// 
			// button3
			// 
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(130, 66);
